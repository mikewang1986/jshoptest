...
//	}
    ...
    private static <T extends Serializable> List<T> getCacheObject(String key){
        return (List<T>)cacheProvider.get(buildKey(key));
    }

    private static <T extends Serializable> Map<String , T> getCacheObjectMap(String key){
        return (Map<String , T>)cacheProvider.get(buildKey(key));
    }
    
    private static <T extends Serializable> T getCacheObjectOne(String key){
...
//        this.catalogs = catalogs;
    ...
    public Map<String, News> getNewsMap() {
        return getCacheObjectMap("newsMap");
    }
    ...
    public Map<String, Attribute> getAttrsMap() {
        return getCacheObjectMap("attrsMap");
    }
    ...
    public SystemSetting getSystemSetting() {
        return getCacheObjectOne("systemSetting");
    }
    ...
    public OrdersReport getOrdersReport() {
        return getCacheObjectOne("ordersReport");
    }
    ...
    public Map<String, AccountRank> getAccountRankMap() {
        return getCacheObjectMap("accountRankMap");
    }
    ...
    public Map<String, NotifyTemplate> getNotifyTemplateMap() {
        return getCacheObjectMap("notifyTemplateMap");
    }
    ...
    public String getAlipayConfig() {
        return getCacheObjectOne("alipayConfig");
    }
    ...
    public String getCommentTypeCode() {
        return getCacheObjectOne("commentTypeCode");
    }
    ...
    public Map<String, Catalog> getCatalogsMap() {
        return getCacheObjectMap("catalogsMap");
    }
    ...
    public Map<String, Catalog> getCatalogsCodeMap() {
        return getCacheObjectMap("catalogsCodeMap");
    }
    ...
    public Map<String, ProductStockInfo> getProductStockMap() {
        return getCacheObjectMap("productStockMap");
    }
     ...
     * @return
     */
    public List<Product> getGoodsTopList() {
    ...
    public Map<String, Area> getAreaMap() {
        return getCacheObjectMap("areaMap");
    }
    ...
    public Map<String, Express> getExpressMap() {
        return getCacheObjectMap("expressMap");
    }
...
//        return advertMap;
        return getCacheObjectMap("advertMap");
    }
...
//        return manageExpressMap;
        Map<String,String> cachedMap = getCacheObjectMap("manageExpressMap");
        if(cachedMap != null){
            return cachedMap;
        }
...
//        return aliyunOSS;
        return getCacheObjectOne("aliyunOSS");
    }
...
//        return activityMap;
        return getCacheObjectMap("activityMap");
    }
...
//        this.activityMap = activityMap;
     ...
     * value:【商品列表ArrayList】
     */
    public Map<String, Product> getActivityProductMap() {
//        return activityProductMap;
        return getCacheObjectMap("activityProductMap");
    }
...
//        return productCatalogJsonStr;
        return getCacheObjectOne("productCatalogJsonStr");
    }
...
//        return articleCatalogJsonStr;
        return getCacheObjectOne("articleCatalogJsonStr");
    }
